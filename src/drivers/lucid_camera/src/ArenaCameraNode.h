...
public:
  ArenaCameraNode()
      : Node("arena_camera_node"),
        node_handle_(std::shared_ptr<ArenaCameraNode>(this, [](auto *) {})),
...
private:
  ...
  bool is_passed_packet_delay_;

  double transmission_delay_;
  bool is_passed_transmission_delay_;
