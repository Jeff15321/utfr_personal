...
ConeDetectionsDisplay::ConeDetectionsDisplay()
    : rviz_common::RosTopicDisplay<utfr_msgs::msg::ConeDetections>(), id_(0),
      marker_common_(
...
void ConeDetectionsDisplay::updateColorOption() {
...
void ConeDetectionsDisplay::updateOrientation() {
...
void ConeDetectionsDisplay::onInitialize() {
  RTDClass::onInitialize();
  marker_common_->initialize(context_, scene_node_);

  topic_property_->setValue("/perception/cone_detections");
  topic_property_->setDescription(
      "utfr_msgs::msg::ConeDetections topic to subscribe to.");

  initMarkers();
}

void ConeDetectionsDisplay::load(const rviz_common::Config &config) {
  Display::load(config);
  marker_common_->load(config);
}

void ConeDetectionsDisplay::processMessage(
    utfr_msgs::msg::ConeDetections::ConstSharedPtr msg) {
...
void ConeDetectionsDisplay::update(float wall_dt, float ros_dt) {
  marker_common_->update(wall_dt, ros_dt);
}

void ConeDetectionsDisplay::reset() {
  RosTopicDisplay::reset();
  marker_common_->clearMarkers();
}

void ConeDetectionsDisplay::initMarkers() {
  ...
  unknown_cone_marker_.scale.z = -z_orientation_;
...
void ConeDetectionsDisplay::setConeMarker(
...
void ConeDetectionsDisplay::setCovarianceMarker(
    const utfr_msgs::msg::Cone &cone, const std_msgs::msg::Header &header,
    const int &id) {
...
visualization_msgs::msg::Marker ConeDetectionsDisplay::getColoredMarker(
...
void ConeDetectionsDisplay::setMarkerArray(
    const utfr_msgs::msg::ConeDetections::ConstSharedPtr &msg) {
...
PLUGINLIB_EXPORT_CLASS(utfr_rviz_plugins::displays::ConeDetectionsDisplay,
                       rviz_common::Display)
